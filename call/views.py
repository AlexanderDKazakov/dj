...
### For form
from .forms import MessageForm, QueryRequest
######## EXPORTING
...
#         )
#     return response
# def get_data_out(request):
#     if request.method == "post":
#         form = QueryRequest(request.POST)
#         if form.is_valid():
#             data = form.cleaned_data
#             period_from = data['period_from']
            # return redirect(export_xls(request, period_from))
            # return render(request, 'list_call.html', {'form': form})
    # else:
    #     return render(request, 'list_call.html', {'form': QueryRequest()})
    #
    # return render(request, 'list_call.html', {'form': form})
